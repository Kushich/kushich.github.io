...
{id: 16, title: 'Car Market', link: '../car-market/index.html', isComplete: false, stack: [html, css, js, bootstrap, vue]}
]
...
// render
function render() {
	const worksHtml = works.reverse().map(createWorksHtml).join('')
